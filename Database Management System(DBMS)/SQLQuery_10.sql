...
2.	Select Student.Rno, Student.Name, Student.Branch, Result.SPI
	From Student
	Inner Join Result
...
3.	Select Student.Rno, Student.Name, Student.Branch, Result.SPI
	From Student
...
4.	Select Student.Branch, avg(Result.SPI) as Avg_SPI
	From Student
	Inner Join Result
	on Student.Rno = Result.Rno
...
5.	Select Student.Branch, avg(Result.SPI) as Avg_SPI
	From Student
	Inner Join Result
	on Student.Rno = Result.Rno
	Group by Student.Branch
...
6.	Select Student.Branch, avg(Result.SPI) as Avg_SPI
	From Student
	Inner Join Result
	on Student.Rno = Result.Rno
